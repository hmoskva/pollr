<%@ Page Title="Create Poll" Language="C#" MasterPageFile="~/MasterUser.Master" AutoEventWireup="true" CodeBehind="USR_CreatePoll.aspx.cs" Inherits="Pollr.User.USR_CreatePoll" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <asp:TextBox ID="txtDes" runat="server" CssClass="form-control" TextMode="MultiLine" />
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-group-lg date form_date hidden-print" data-date="" data-date-format="dd/mm/yy" data-link-field="txtStartDate" data-link-format="dd/mm/yy">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group input-group-lg date form_date hidden-print" data-date="" data-date-format="dd/mm/yy" data-link-field="txtEndDate" data-link-format="dd/mm/yy" >
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group">
                        <asp:GridView ID="gdvabsPoll" runat="server" CssClass="table table-striped table-responsive" AutoGenerateColumns="False" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" AllowPaging="True">
                            <Columns>
                                <asp:TemplateField HeaderText="S/N">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-2 btn-group">
                                <asp:Button ID="btnSaveOption" runat="server" CssClass="btn btn-primary" Text="Save" OnClick="btnSaveOption_Click" />
